	...
	*/
	...
	imgUp.src = '/Librerias/JavaScript/SimpleCalendar/images/up.gif';
	var imgDown = new Image(8,12);
	imgDown.src = '/Librerias/JavaScript/SimpleCalendar/images/down.gif';
	...
	if (browser.dom || browser.ie4){
		...
		browser.platform=='Win32'?height=155:height=160;
	...
	function Calendar(){
	  ...
	  this.daysOfWeek = new Array("Do","Lu","Ma","Mi","Ju","Vi","Sa");
	...
	Calendar.prototype.buildString = function(){
	  ...
	  if (this.hasDropDown) {
	    ...
	    tmpStr += '<table border="0" cellpadding="0" class="calBorderColor"><tr><td><a href="javascript: g_Calendar.changeMonth(-1);"><img name="calendar" src="/Librerias/JavaScript/SimpleCalendar/images/down.gif" width="8" height="12" noborder border="0" alt=""></a></td><td class="cal" width="100%" align="center">' + this.months[this.month] + '</td><td class="calBgColor"><a href="javascript: g_Calendar.changeMonth(+1);"><img name="calendar" src="/Librerias/JavaScript/SimpleCalendar/images/up.gif" width="8" height="12" noborder border="0" alt=""></a></td></tr></table>';
	  }
	  tmpStr += '</td>';
	  ...
	  */
	  ...
	  tmpStr += '<table border="0" cellpadding="0" class="calBorderColor"><tr><td><a href="javascript: g_Calendar.changeYear(-1);"><img name="calendar" src="/Librerias/JavaScript/SimpleCalendar/images/down.gif" width="8" height="12" noborder border="0" alt=""></a></td><td class="cal" width="100%" align="center">' + this.year + '</td><td class="calBgColor"><a href="javascript: g_Calendar.changeYear(+1);"><img name="calendar" src="/Librerias/JavaScript/SimpleCalendar/images/up.gif" width="8" height="12" noborder border="0" alt=""></a></td></tr></table>'
	  }
	  tmpStr += '</td>';
	  tmpStr += '</tr>';
	  tmpStr += '</table>';
