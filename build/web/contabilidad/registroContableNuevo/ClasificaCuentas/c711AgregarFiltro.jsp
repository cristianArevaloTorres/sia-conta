...
<%
  //para el llenado de combo con inf. de RF_TC_CLASIFICADOR_CUENTAS - RF_TR_CONFIGURA_CLAVES, sólo los que no esten en configura_claves
  /**
    * Descripcion: Metodo que lee la informacion de RF_TC_CLASIFICADOR_CUENTAS QUE NO
    *  EXISTE NE RF_TR_CONFIGURA_CLAVES, PARA LLENAR COMBO DE FILTRO
    * <p>Fecha de creación: 09/dic/2010               </p>
  ...
  */ 
  ...
  String SQL = "SELECT * FROM (SELECT RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR_ID, RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR, "+
               " RF_TR_CONFIGURA_CLAVES.ID_CONF_CVE, RF_TC_CLASIFICADOR_CUENTAS.DESCRIPCION, RF_TC_CLASIFICADOR_CUENTAS.CONF_CVE_CTA_CONT_ID " +
               ...
               " WHERE (a.CONF_CVE_CTA_CONT_ID = 0) ORDER BY CUENTA_MAYOR "; 
 ...
 // System.out.println(SQL);             
  ...
  try{
     ...
     abCtasMayor.execute(con);
       ...
       System.out.println("Ocurrio un error al crear CachedRowSet de CtasMayor en c711AgregarFiltro.jsp "+e.getMessage());
     } //Fin catch
     finally{
       if (con!=null){
         con.close();
...
<html>
        ...
        function Valida(){
            ...
            if(!isEmpty(Filtro.txtNumero.value)){
                if(Filtro.txtNumero.value.length != 4 ){
                   ok=false; mess=mess+'Número de Cuenta debe ser máximo de 4 carácteres\n';
                }
  ...
  <body>
  <jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Clasificador de Cuentas", "[Agregar]", "Filtro", true);</jsp:scriptlet>

     <form name="Filtro" id="Filtro" method="post" action="c711AgregarResultado.jsp">
            ...
            <td class="negrita">
			   ...
			   String CtaMay="";
                           ...
                           while (abCtasMayor.next()){ 
                                  ...
                                  IdConfCve=abCtasMayor.getString(3);
				  Descrip=abCtasMayor.getString(4);
                                  if(!IdCM.equals("")){
                       %>
