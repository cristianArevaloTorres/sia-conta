...
<html>
  <head>
    ...
    <title>c711AgregarResultado</title>
    <link rel="stylesheet" href="../../../Librerias/Estilos/siastyle.css" type='text/css'>
    <script language="JavaScript" src="../../../Librerias/Javascript/Capturador/funciones.js" type="text/javascript"></script>
  </head>
  <body>
        <jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Clasificador de Cuentas","[Agregar]", "Resultado", true);</jsp:scriptlet>
...
<!-- Encabezado de la tabla con resultado del filtro -->
        ...
        <FORM name="resultado" id="resultado" Method="post" action="c711AgregarFormulario.jsp">
<!-- (Inicia codigo JAVA) -->
<%
 //Connection conexion=null;
    String lsCtaMayorId="";
...
//    conexion=DaoFactory.getContabilidad();
    ...
    // Listar las cuentas de mayor que no han sido configuradas solamente 
    Query = "SELECT * FROM (SELECT RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR_ID, RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR, "+
            ...
            " WHERE (a.CONF_CVE_CTA_CONT_ID = 0) "+lsCondicion+" ORDER BY CUENTA_MAYOR ";
/*        
...
//System.out.println("Query : "+Query);
      ...
      xPaginacion.SeleccionarHorizontalQuery(conexion, DefQuery, DefAlias, DefInput, out, 1, "<a href=c711AgregarFormulario.jsp","?NCta=", ">", false);
    ...
    <table width="100%">
        ...
        <tr> 
            <td colspan="2" align=right>
                <div align="center"> 
                    <input type="button" name="btnRegresar" value="Regresar" class="boton" onClick="javascript:LlamaPagina('c711AgregarFiltro.jsp','');">
                </div>
            </td>
        </tr>
    </table>
