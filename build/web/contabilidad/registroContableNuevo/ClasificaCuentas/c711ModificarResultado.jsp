...
<html>
  <head>
    ...
    <title>c711ModificarResultado</title>
    <link rel="stylesheet" href="../../../Librerias/Estilos/siastyle.css" type='text/css'>
    <script language="JavaScript" src="../../../Librerias/Javascript/Capturador/funciones.js" type="text/javascript"></script>
  </head>
  <body>

<jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Clasificador de Cuentas", "[Modificar]", "Resultado",  true);</jsp:scriptlet>
...
//System.out.println("Query : "+Query);
      ...
      xPaginacion.SeleccionarHorizontalQuery(conexion, DefQuery, DefAlias, DefInput, out, 1, "<a href=c711ModificarFormulario.jsp","?NCta=", ">", false);
    ...
    <table width="100%">
        ...
        <tr> 
            <td colspan="2" align=right>
                <div align="center"> 
                    <input type="button" name="btnRegresar" value="Regresar" class="boton" onClick="javascript:LlamaPagina('c711ModificarFiltro.jsp','');">
                </div>
            </td>
        </tr>
    </table>
