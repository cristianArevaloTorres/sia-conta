...
ResultSet crs=null;
try{
crs = pbRegCont.cargaSubcuentas(con,nr,n1,n2,n3,n4,n5,n6,n7,n8,"",catCuentaId,uniEje,entidad,ambito,ejercicio,String.valueOf(Autentifica.getNumeroEmpleado()));
%>
...
<%
       ...
       System.out.println("Ocurrio un error al accesar la capa c700CapaPoliza8.jsp "+e.getMessage());
%>
