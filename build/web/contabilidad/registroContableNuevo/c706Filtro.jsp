...
function revisaFormulario() {
   ...
   encontroPocicion=false;
      ...
      if(document.getElementById('hTipoFormato').value == 'central')
        encontroPocicion= true;
      if(!encontroFormato)
        cadenaError+='Selecione el tipo de formarto del cheque.\n';
      if(!encontroPocicion)
         cadenaError+='Selecione la pocición en que requiere se imprima el cheque.\n';
  ...
  if ((document.getElementById('txtFecha01').value=="") && (!document.getElementById('txtFecha02').value=="")){
   ...
   if(!valida01 || !encontroFormato || !encontroPocicion)
   //if(!valida01)
       alert(cadenaError);
   else        
  ...
  <body>
    ...
    <FORM name="filtro" method="post"  action="c706Resultado.jsp">
...
<%      
      ...
      <tr><td  class="negrita" align="right">Importe: </td>
       ...
       <tr ><td class="negrita" align="right">Formato de cheque: </td>
         <td>
         <table align="left">
           <tr><td><input type="radio" name="tipoFormato" value="central" onclick="activarPociciones(this.value)"/>Formato centralizado (1 cheque por pagina con su póliza)</td></tr> 
  ...
  <table cellpadding="5"  border="0" width="15%" class="sianoborder" align="center">
    <tr align="center">
      <td  align="right"><input type='button' name='btnAceptar' value='Aceptar' class='boton' onClick="javascript:revisaFormulario();"></td>
          <td><input type='button' name='btnRegresar' value='Regresar' class='boton' onClick="javascript:LlamaPagina('filtroGeneral.jsp?opcion=imprimeCheques&idCatalogoCuenta=1','');"></td>
    </tr>
  </table>
  <br>
    </FORM>
