...
<html>
    <head>
        ...
        <script language="JavaScript" type="text/javascript">
            // Funcion encargada de verificacion de la informacion capturada 
            // en el formulario
            function revisaFormulario() {
                ...
                // Validacion para que a fecha de INICIO del periodo no este vacia
                ...
                // Validacion para que a fecha de FINAL del periodo no este vacia
                if ((!document.filtro.txtFecha01.value=="") && (document.filtro.txtFecha02.value=="")){
                    valida01=false;
            ...
            function enviaFiltro() {
                filtro.action="../filtroGeneral.jsp?opcion=aplicarCarga";
                filtro.submit();
            }
        </script>
    </head>
    <body>
        ...
        <jsp:scriptlet>util.tituloPagina(out, "Contabilidad", " ", "Filtro de polizas", "Aplicar", true);</jsp:scriptlet>    
        ...
        <FORM name="filtro" method="post"  action="c722Resultado.jsp">
            ...
            <input type='hidden' name='pagina' value='aplicarCarga'>
            ...
            <table align="center">
                ...
                <tr><td  class="negrita" align="right">Concepto: </td>
                    <td ><INPUT TYPE="text" NAME="txtConcepto" SIZE=20  class=cajaTexto > </td>
                </tr>       
                <tr><td  class="negrita" align="right">Referencia General: </td>
                    <td ><INPUT TYPE="text" NAME="txtRefGral" SIZE=20  class=cajaTexto > </td>
                </tr>               
                ...
                <tr>
                    ...
                    <td>
                        <input type='button' name='btnRegresar' value='Regresar' class='boton' onClick="enviaFiltro()"></td>
                </tr>
            </table>            
        </FORM>
    </body>
