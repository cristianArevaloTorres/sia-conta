...
<body>
<jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Cuentas de Mayor", "[Consultar]", "Resultado", true);</jsp:scriptlet>
...
<%
 ...
 try{
    conexion=DaoFactory.getContabilidad();
      ...
      // if(!lsFecha01.equals("")){
      //     if(!lsFecha02.equals("")){
      //        lsCondicion = lsCondicion + " and fecha_vig_ini = '" + lsFecha01 + "' ";
      //      }
      // }
       ...
       String [] DefAlias={"CONSFILA-,VALOR-,DESCRIPCION-,NATURALEZA-,FECHAINI-,FECHAFIN","10%,15%,45%,10%,10%,10%","No. Consecutivo,Cuenta de Mayor,Descripción,Naturaleza,Fecha Inicial,Fecha Final","4,4"};
...
<table align="center">
 <tr>
     <td align="center">
            <INPUT TYPE='button' NAME="btnRegresar" VALUE="Regresar" class='boton' onClick="javascript:LlamaPagina('c710ConsultarFiltro.jsp','');" >           
        </td>
    </tr>   
</table>
