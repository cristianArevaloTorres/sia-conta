...
<%
    ...
    } else if (opcion.equals("cancelarm")){
        pagina = "polizas/reexpedir/c749Filtro.jsp?opcion=cancelarm";
    }else if (opcion.equals("cancelarAre")){
        pagina = "polizas/reexpedir/c750Filtro.jsp?opcion=cancelarAre";
    }else if(opcion.equals("aplicaCheques")){
       pagina = "c705Filtro.jsp";
    } else if(opcion.equals("imprimeCheques")){
       pagina = "c706Filtro.jsp";
    } else if(opcion.equals("chequeManual")){
       pagina = "c721Filtro.jsp";
    } else if(opcion.equals("reactivaCheques")){
       pagina = "c707Filtro.jsp";
    } else if(opcion.equals("eliminarCarga")){
      pagina = "cheques/eliminacion/743Filtro.jsp";
    } else if(opcion.equals("folioFinal")){
      pagina = "cheques/folioFinal/c735Control.jsp";
    } else if(opcion.equals("consultaCheques")){
      pagina = "c719consultaCheques.jsp";
    }
