...
<html>
  <head>
    ...
    <title>c719FormasFiltro</title>
    <link rel="stylesheet" href="../../../Librerias/Estilos/siaexplorer.css" type="text/css">
  </head>
  <body>
    <%util.tituloPagina(out,"Contabilidad institucional","Filtro captura a través de formas","Filtro captura a través de formas",true);
    crsTiposPoliza.registros(DaoFactory.CONEXION_CONTABILIDAD,"select tipo_poliza_id, descripcion, abreviatura from RF_TC_TIPOS_POLIZAS");%>
    <jsp:directive.include file="../encabezadoFechaActual.jspf" />
    <form action="../formas/c719FormasResultado.jsp" method="POST" id="forma">
