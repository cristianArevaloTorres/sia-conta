<%-- 
    Document   : 750Filtro
    Created on : 17/08/2017, 02:06:37 PM
...
function revisaFormulario() {
  ...
  if ((document.filtro.txtFecha01.value=="") && (!document.filtro.txtFecha02.value=="")){
   ...
   if ((!document.filtro.txtPoliza01.value=="") && (document.filtro.txtPoliza02.value=="")){
       valida01=false;
       cadenaError=cadenaError+"Es necesario escribir el rango de cheques completo\n";
   }
   if ((document.filtro.txtPoliza01.value=="") && (!document.filtro.txtPoliza02.value=="")){
       valida01=false;
       cadenaError=cadenaError+"Es necesario escribir el rango de cheques completo\n";
  ...
  //String pagina= controlReg.getPagina();
     ...
     "and cc.cuenta_cheques_id not in(9999,115) "+
...
<br><br>
    ...
    <FORM name="filtro" method="post"  action="c750Resultado.jsp">        
    <table align="center">
...
<%      
       ...
       <tr style="display:none"><td  class="negrita" align="right">Mes de Afectación: </td>
