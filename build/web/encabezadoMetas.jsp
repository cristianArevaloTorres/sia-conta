...
%>
        ...
        <td width="10%" align="center">
            <a href="<%=request.getContextPath()%>/presupuesto/metasInst/Seguimiento/p001Index.jsp?rama=01&contenedor=1" target="_parent" style="color:white; text-decoration:none;">
                <img src="<%=util.getContexto(request)%>/Librerias/Imagenes/encabezado/home.gif" alt="Inicio metas" border="0"/>
            </a>
            <a href="<%=request.getContextPath()%>/contenedorMetasGenral.jsp?menu=arbol" target="_top" style="color:white; text-decoration:none;">
                <img src="<%=imagenArbol%>" alt="Menu" border="0"/>
            </a>
            <a href="<%=request.getContextPath()%>/contenedorMetasGenral.jsp?menu=outlook" target="_top" style="color:white; text-decoration:none;">
                <img src="<%=imagenOutlook%>" alt="Menu" border="0"/>
            </a>
       ...
       [<%= Autentifica.getDesSiglasUE().concat("][").concat(Autentifica.getDesSiglasEntidad().toUpperCase()).concat("][").concat(Autentifica.getDesAmbito().toUpperCase())%>]&nbsp;&nbsp;&nbsp;
    </td>
  </tr>
  <tr>
