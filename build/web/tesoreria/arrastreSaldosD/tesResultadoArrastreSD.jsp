...
<html>
  <head>
    ...
    <title>tesResultadoArrastreSD</title>
  ...
  <%!
    private boolean ejecutaArrastreSaldos(int iProg, String fecha, Connection conn){
        ...
        sbProceso.append("begin TSR.RELLENA_DIAS_SIN_SALDOBMX(");
  ...
  <body>
   <form id="form1" name="form1" action="../tesListadoProgramas.jsp" method="POST">
    <%util.tituloPagina(out,"Tesorería","Saldos diarios - Bancos","Resultado del arrastre de saldos bancarios",true);%>
