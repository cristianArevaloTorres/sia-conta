...
<html>
  <head>
    ...
    <title>i003tesTasasRendimientoMenu</title>
	...
	<table width="80%" border="0" cellspacing="0">
      ...
      <td width="15%">
        <div align="center"><font color="#0066CC"><strong><img src="../../Librerias/Imagenes/pelota_azulclaro.gif" width="14" height="16" align="texttop">
          &nbsp;<a href='i003tesTasasRendimientoAgregar.jsp' target="contenido" onclick="cambia(0)">Agregar</a>&nbsp;</strong></font></div>
      ...
      <td width="15%">
        <div align="center"><font color="#0066CC"><strong><img src="../../Librerias/Imagenes/pelota_azuloscuro.gif"  width="14" height="16" align="texttop">
          &nbsp;<a href='i003tesTasasRendimientoFiltro.jsp?arbol=1' target="contenido" onclick="cambia(1)">Modificar</a>&nbsp;</strong></font></div></td>
