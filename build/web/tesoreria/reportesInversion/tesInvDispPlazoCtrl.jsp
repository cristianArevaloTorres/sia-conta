...
<html>
  <head>
    ...
    <title>tesInvDispPlazoCtrl</title>
    ...
    private String getQueryReporte(HttpServletRequest request){
        ...
        try  {      
            ...
            regresa = sentencia.getCommand("consultas.select.invDispAPlazos.reportesInversiones");
        } catch (Exception e)  {
           e.printStackTrace();
        }  finally  {
              sentencia = null;
  ...
  <%
    ...
    try  { 
        ...
        if (request.getParameter("tipoReporte").equals("pdf"))
            request.getSession().setAttribute("rutaArchivo","/tesoreria/reportesInversion/Reportes/invDispPPlazo");
        else                                          
            request.getSession().setAttribute("rutaArchivo","/tesoreria/reportesInversion/Reportes/invDispPPlazoXls");
