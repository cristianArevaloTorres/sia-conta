...
<html>
  <head>
    ...
    <title>tesInversionTipoInst</title>
    ...
    <script src="../../Librerias/Javascript/validacionesFecha.js" type="text/javascript">
      ...
      <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesInversionTipoInstCtrl.jsp';
  ...
  %>
  <body>
  <form id="form1" name="form1" action="tesInversionTipoInstCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Inversión por tipo de instrumento","Reporte",true);%>
