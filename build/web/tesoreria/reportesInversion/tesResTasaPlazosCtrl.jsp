...
<html>
  <head>
    ...
    <title>tesResTasaPlazosCtrl</title>
   <script language="JavaScript"  type="text/javascript">
    ...
    private String getQueryReporte(HttpServletRequest request){
        ...
        try  {      
            ...
            sentencia.addParam("plazo",request.getParameter("plazo"));
            regresa = sentencia.getCommand("consultas.select.tasasRendimiento.reportesInversiones");
        } catch (Exception e)  {
           e.printStackTrace();
        }  finally  {
              sentencia = null;
  ...
  <%
    ...
    try  { 
        ...
        if (request.getParameter("plazo").equals("1"))        
            parametros.put("PLAZO",request.getParameter("plazo").concat(" día"));
        else
            parametros.put("PLAZO",request.getParameter("plazo").concat(" dias"));
        ...
        if (request.getParameter("tipoReporte").equals("pdf"))
            request.getSession().setAttribute("rutaArchivo","/tesoreria/reportesInversion/Reportes/resumenTasaPlazo");
        else
            request.getSession().setAttribute("rutaArchivo","/tesoreria/reportesInversion/Reportes/resumenTasaPlazoXls");
        request.getSession().setAttribute("nombreArchivo","resumenTasasPlazo");
