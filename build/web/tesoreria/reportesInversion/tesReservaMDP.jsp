...
<html>
  <head>
    ...
    <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesReservaMDPCtrl.jsp';
  ...
  <body>
  <form id="form1" name="form1" action="tesReservaMDPCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Comportamiento de la reserva expresado en mdp","Reporte",true);%>
