...
<html>
    ...
    <script src="../../Librerias/Javascript/validacionesFecha.js" type="text/javascript">
      ...
      <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesResumenTasaIFCtrl.jsp';
  ...
  <%
    ...
    crsTasas.registrosMap(DaoFactory.CONEXION_TESORERIA,"catalogos.select.RfTrTasasRendExisten.reportesInversiones");
    crsTasas.liberaParametros();
    
  %>
  <body>
  <form id="form1" name="form1" action="tesResumenTasaIFCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Resumen de tasas de rendimiento por Institución Financiera","Reporte",true);%>
        ...
        <tbody>
             <tr>
              ...
              <tr>
                <td>Plazos:</td>
                <td>
                  <select class="cajaTexto" id="plazo" name="plazo" multiple="multiple" > 
                      <%CRSComboBox(crsTasas, out,"PLAZO","PLAZO","");%>
                  </select>
                </td>
             </tr>
        </tbody>
