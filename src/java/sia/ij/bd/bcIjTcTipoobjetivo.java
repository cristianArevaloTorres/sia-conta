...
public class bcIjTcTipoobjetivo extends BeanBase {
		
  private String idtipoobjetivo;
	private String descripcion;
	private String estatus;
  
	public bcIjTcTipoobjetivo() {
		limpia();
	}
  ...
  private void getNext(Connection con) throws  Exception {
    ...
    try {
      ...
      SQL = new StringBuffer("select max(IDTIPOOBJETIVO) + 1 valoractual from IJ_TC_TIPOOBJETIVO");
      rsQuerySeq = stQuery.executeQuery(SQL.toString());
      while (rsQuerySeq.next()){
        idtipoobjetivo = rsQuerySeq.getString("valoractual");
      } //del while
      if(idtipoobjetivo == null)
        idtipoobjetivo = "1";
  ...
  public int select(Connection con) throws Exception {
    ...
    SQL = new StringBuffer();
			SQL.append("select \n");
			SQL.append("  IDTIPOOBJETIVO, \n");
			SQL.append("  DESCRIPCION, \n");
			SQL.append("  ESTATUS \n");
			SQL.append("from \n"); 
			SQL.append("  IJ_TC_TIPOOBJETIVO\n");
			SQL.append("where \n");
			SQL.append("  IDTIPOOBJETIVO = " + idtipoobjetivo + "  ");
    ...
    try {
      ...
      if (rsQuery.next() )  {
        ...
        limpia();
              ...
              idtipoobjetivo = rsQuery.getString("IDTIPOOBJETIVO")==null?"":rsQuery.getString("IDTIPOOBJETIVO");
      ...
      System.out.println("bcIjTcTipoobjetivo.select: " + SQL.toString());
      throw new Exception(SQL.toString(),e);
    }
    finally {
      if (rsQuery != null) 
  ...
  public void insert(Connection con) throws  Exception {
    ...
    try {
      ...
      SQL = new StringBuffer();
      SQL.setLength(0);
      SQL.append("insert into IJ_TC_TIPOOBJETIVO ( ");
      SQL.append("IDTIPOOBJETIVO, ");
      SQL.append("DESCRIPCION, ");
      SQL.append("ESTATUS ");
      SQL.append("\n) values (");
      SQL.append(getCampo(idtipoobjetivo)+", ");
...
//3
      ...
      System.out.println("bcIjTcTipoobjetivo.insert: " + SQL);
      idtipoobjetivo = "-1";
  ...
  public void update(Connection con) throws  Exception {
       ...
       SQL.append("update IJ_TC_TIPOOBJETIVO set \n");
       SQL.append("  IDTIPOOBJETIVO = " + getCampo(idtipoobjetivo)+", \n");
...
//10
       ...
       try {
          ...
          System.out.println("bcIjTcTipoobjetivo.update: "+SQL);
          throw new Exception(SQL.toString(),e);
       }
       finally {
          if (stQuery != null) {
  ...
  public void delete(Connection con) throws  Exception {
      ...
      try {
        stQuery=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
        SQL = "delete from IJ_TC_TIPOOBJETIVO where IDTIPOOBJETIVO = " + idtipoobjetivo + " " ;
        rs=stQuery.executeUpdate(SQL);
      }
     catch (Exception e) {
        System.out.println("Ha occurrido un error en el metodo delete");
        System.out.println("bcIjTcTipoobjetivo.delete: "+SQL);         
        throw new Exception(SQL.toString(),e);
      }
      finally {                  
        if (stQuery != null) {
