...
public class Capitulo implements Function {
  ...
  public Object computeFunction(Interpreter interpreter, Object [] parametersValue) {
    ...
    return getCapitulo(parametersValue[INDEX_NUMERO]);
  }
  ...
  private int getCapitulo(Object parametro){
    String sentencia     = getPropiedad("funciones.query.obtenerCapitulo");
    ...
    if(registros!= null) {
      ...
      capitulo=Integer.valueOf(registro.getField("CAPITULO"));
    }
    return capitulo;
  }
