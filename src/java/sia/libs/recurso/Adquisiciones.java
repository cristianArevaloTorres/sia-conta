...
public class Adquisiciones {
  private static final String NOMBRE= "adquisiciones";
  
  private static Adquisiciones instance; 
  ...
  private Adquisiciones() {
    setProperties(loadProperties());
  }
  
  public static Adquisiciones getInstance(){
    if (instance== null) {
      synchronized (mutex) {
        if (instance== null)
          instance= new Adquisiciones();
      }
    }
    return instance;
  }  
