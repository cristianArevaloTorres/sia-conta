...
public class Tesoreria {
  ...
  private static final String NOMBRE= "tesoreria";
  
  private static Tesoreria instance; 
  ...
  public static Tesoreria getInstance(){
    if (instance== null) {
      synchronized (mutex) {
        if (instance== null)
          instance= new Tesoreria();
      }
    }
    return instance;
  }  
  ...
  private Properties loadProperties() { 
    ...
    try {
      ...
      Error.mensaje(e, "SIAFM", "Error: No puede leer el archivo de propiedades.\nEstar seguro que esta en el CLASSPATH ".concat("tesoreria").concat(".properties"));
    }    
    return null;
  }
