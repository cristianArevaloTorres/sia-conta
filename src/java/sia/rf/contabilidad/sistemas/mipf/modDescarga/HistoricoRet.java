...
public class HistoricoRet{ 
   ...
   * @param idhistret 
   */ 
   public void setIdhistret( String idhistret ) { 
      this.idhistret=idhistret; 
   } 

    /** 
    * Metodo que lee la informacion de rf_tr_histret, el query viene como parametro
    * Fecha de creacion: 
    * Autor: 
    * Fecha de modificacion: 
    * Modificado por: 
    */ 
    public CachedRowSet select_rf_tr_histret_bd(Connection con, String query)throws SQLException, Exception{ 
       ...
       try{ 
        ...
        System.out.println("Ocurrio un error al accesar al metodo select_rf_tr_histret_bd "+e.getMessage()); 
      ...
      return rsQuery;
    } //Fin metodo select_rf_tr_histret_bd 
  
   /** 
   * Metodo que lee la informacion de rf_tr_histret 
   * Fecha de creacion: 
   * Autor: 
   * Fecha de modificacion: 
   * Modificado por: 
   */ 
   public void select_rf_tr_histret(Connection con, String clave)throws SQLException, Exception{ 
      Statement stQuery=null; 
      ResultSet rsQuery=null; 
      try{ 
       stQuery=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE); 
       StringBuffer SQL=new StringBuffer("SELECT a.actividad,a.prioridad,a.proceso,a.subproceso,a.macro,a.unidad,a.estado,a.partida,a.mes,a.tipoeje,a.cxlc,a.docoreco,a.cveret,a.concepto,a.importe,a.fechaaut,a.fechacap,a.ident,a.idhistret");  
       SQL.append(" FROM rf_tr_histret a "); 
       SQL.append(" WHERE a.idhistret=").append(clave).append(" "); 
       System.out.println(SQL.toString()); 
       ...
       while (rsQuery.next()){ 
          ...
          idhistret=(rsQuery.getString("idhistret")==null) ? "" : rsQuery.getString("idhistret"); 
       } // Fin while 
     } //Fin try 
     catch(Exception e){ 
       System.out.println("Ocurrio un error al accesar al metodo select_rf_tr_histret "+e.getMessage()); 
       throw e; 
     } //Fin catch 
     finally{ 
       if (rsQuery!=null){ 
   ...
   } //Fin metodo select_rf_tr_histret 
  
   /** 
   * Metodo que inserta la informacion de rf_tr_histret 
   * Fecha de creacion: 
   * Autor: 
   * Fecha de modificacion: 
   * Modificado por: 
   */ 
   public void insert_rf_tr_histret(Connection con)throws SQLException, Exception{ 
      Statement stQuery=null; 
      try{ 
       stQuery=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE); 
       StringBuffer SQL=new StringBuffer("INSERT INTO rf_tr_histret( actividad,prioridad,proceso,subproceso,macro,unidad,estado,partida,mes,tipoeje,cxlc,docoreco,cveret,concepto,importe,fechaaut,fechacap,ident,idhistret) ");  
       SQL.append("VALUES("); 
       ...
       SQL.append(idhistret).append(")"); 
       System.out.println(SQL.toString()); 
       int rs=-1; 
       rs=stQuery.executeUpdate(SQL.toString()); 
     } //Fin try 
     catch(Exception e){ 
       System.out.println("Ocurrio un error al accesar al metodo insert_rf_tr_histret "+e.getMessage()); 
       throw e; 
     } //Fin catch 
     finally{ 
       if (stQuery!=null){ 
   ...
   } //Fin metodo insert_rf_tr_histret 
  
   /** 
   * Metodo que modifica la informacion de rf_tr_histret 
   * Fecha de creacion: 
   * Autor: 
   * Fecha de modificacion: 
   * Modificado por: 
   */ 
   public void update_rf_tr_histret(Connection con, String clave)throws SQLException, Exception{ 
      Statement stQuery=null; 
      try{ 
       stQuery=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE); 
       StringBuffer SQL=new StringBuffer("UPDATE rf_tr_histret"); 
       ...
       SQL.append("idhistret=").append(idhistret); 
       SQL.append(" WHERE idhistret=").append(clave).append(" "); 
       System.out.println(SQL.toString()); 
       int rs=-1; 
       rs= stQuery.executeUpdate(SQL.toString()); 
     } //Fin try 
     catch(Exception e){ 
       System.out.println("Ocurrio un error al accesar al metodo update_rf_tr_histret "+e.getMessage()); 
       throw e; 
     } //Fin catch 
     finally{ 
       if (stQuery!=null){ 
   ...
   } //Fin metodo update_rf_tr_histret 
  
   /** 
   * Metodo que borra la informacion de rf_tr_histret 
   * Fecha de creacion: 
   * Autor: 
   * Fecha de modificacion: 
   * Modificado por: 
   */ 
   public void delete_rf_tr_histret(Connection con, String clave)throws SQLException, Exception{ 
      Statement stQuery=null; 
      try{ 
       stQuery=con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE); 
       StringBuffer SQL=new StringBuffer("DELETE FROM rf_tr_histret a "); 
       SQL.append("WHERE a.idhistret=").append(clave).append(" "); 
       System.out.println(SQL.toString()); 
       int rs=-1; 
       rs=stQuery.executeUpdate(SQL.toString()); 
       ...
       System.out.println("Ocurrio un error al accesar al metodo delete_rf_tr_histret "+e.getMessage()); 
       throw e; 
     } //Fin catch 
     finally{ 
       if (stQuery!=null){ 
   ...
   } //Fin metodo delete_rf_tr_histret 
} //Fin clase HistoricoRet 
