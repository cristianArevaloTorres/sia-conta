...
/*  String SQL = "SELECT RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR_ID, RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR, "+
    ...
    String SQL = "SELECT DISTINCT RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR_ID, RF_TC_CLASIFICADOR_CUENTAS.CUENTA_MAYOR, RF_TC_CLASIFICADOR_CUENTAS.DESCRIPCION, "+
                             " RF_TR_CONFIGURA_CLAVES.ID_CONF_CVE, DECODE(RF_TC_CLASIFICADOR_CUENTAS.NATURALEZA,'A','Acreedora','D','Deudora') as naturaleza, "+
                             ...
                             " WHERE (RF_TR_CUENTAS_CONTABLES.CUENTA_MAYOR_ID IS NULL and RF_TC_CLASIFICADOR_CUENTAS.CONF_CVE_CTA_CONT_ID <>  0 )  ORDER BY CUENTA_MAYOR ";
 ...
 // System.out.println(SQL);             
  ...
  try{
     ...
     abCtasMayor.execute(con);
       ...
       System.out.println("Ocurrio un error al crear CachedRowSet de CtasMayor en c711EliminarFiltro.jsp "+e.getMessage());
     } //Fin catch
     finally{
       if (con!=null){
         con.close();
...
<html>
  ...
  <body>
  <jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Clasificador de Cuentas", "[Eliminar]","Filtro", true);</jsp:scriptlet>

     <form name="Filtro" id="Filtro" method="post" action="c711EliminarResultado.jsp">
