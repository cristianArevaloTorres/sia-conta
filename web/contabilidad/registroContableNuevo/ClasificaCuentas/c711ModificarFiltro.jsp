...
//  System.out.println(SQL);             
  ...
  try{
     ...
     abCtasMayor.execute(con);
       ...
       System.out.println("Ocurrio un error al crear CachedRowSet de CtasMayor en c711ModificarFiltro.jsp "+e.getMessage());
     } //Fin catch
     finally{
       if (con!=null){
         con.close();
...
<html>
  ...
  <body>
  <jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Clasificador de Cuentas", "[Modificar]", "Filtro",  true);</jsp:scriptlet>

     <form name="Filtro" id="Filtro" method="post" action="c711ModificarResultado.jsp">
