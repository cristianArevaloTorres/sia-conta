...
*/   
  ...
  <body>
    ...
    <FORM name="filtro" method="post"  action="c707Resultado.jsp">
...
<%      
      ...
      <tr>
          ...
          <td><input type='button' name='btnRegresar' value='Regresar' class='boton' onClick="javascript:LlamaPagina('filtroGeneral.jsp?opcion=reactivaCheques&idCatalogoCuenta=1','');"></td>
      </tr>
    </table>            
    </FORM>
  </body>
