<%-- 
    Document   : c719consultaCheques
    Created on : 11/01/2017, 01:16:59 PM
...
<%
 ...
 // "and cc.unidad_ejecutora = "+ lsUnidad +" and cc.ambito = "+lsAmbito+" and cc.entidad = "+lsEntidad+
...
<html>
  <head>
    ...
    <title>c719consultaCheques</title>
...
*/   
  ...
  <body>
    ...
    <FORM name="filtro" method="post"  action="c719Resultado.jsp">
...
<%      
       ...
       <tr><td  class="negrita" align="right">Consecutivo (N&uacute;mero de cheque): </td>
      ...
      <tr>
          ...
          <td><input type='button' name='btnRegresar' value='Regresar' class='boton' onClick="javascript:LlamaPagina('filtroGeneral.jsp?opcion=consultaCheques&idCatalogoCuenta=1','');"></td>
      </tr>
    </table>            
    </FORM>
  </body>
