...
//DE ENTRADA CARGA  SIN NINGUN VALOR
...
//SE ENCARGA DE HACER EL LLAMADO A LA CAPA PARA MOSTRAR LOS VIDEOS DEPENDIENDO DEL TEXTO ELECCIONADA 
...
<body>
<jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Cuentas de Mayor ", "[Consultar]", "Filtro", true);</jsp:scriptlet>
<FORM Method="post" name="Filtro" action="c710ConsultarResultado.jsp" >
<%
...
%>
 ...
 <tr> 
      ...
      <td><div align="left"><SELECT NAME="lstGenero" class='cajaTexto' OnChange='ComponerListaSS(Filtro.lstGenero[selectedIndex].value);'>
...
<!--  Capa que devuelve las Videoconferencias -->
...
<table width="100%" border=0>   
 <tr> 
      ...
      <td><div align="left"><input align="left" type="text" name="txtNombre" maxlength="100" size="60"  class="cajaTexto" onChange="javascript:this.value=this.value.toUpperCase();"/>
      </div></td>
</tr>
  <tr>      
...
<table align="center">
 <tr>
  ...
  <input type='hidden' name='txtOpcion' value='C'>
</form>
</BODY>
</html>
<%
