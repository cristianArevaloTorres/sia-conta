...
<body>
<jsp:scriptlet>util.tituloPagina(out, "Contabilidad", "Cuentas de Mayor ", "[Modificar]", "Filtro", true);</jsp:scriptlet>
<FORM Method="post" name="Filtro" action="c710ModificarResultado.jsp" >
<%
...
<table align="center">
 <tr>
  ...
  <input type='hidden' name='txtOpcion' value='M'>
</form>
</BODY>
</html>
<%
