...
<html>
    ...
    <body >
        ...
        <br>
        <FORM name="resultado" id="resultado" Method="post" action="c749Control.jsp" onsubmit='return revisarForm();' >
                        ...
                        <%
                            ...
                            try {
                                ...
                                Query = "select ROWNUM CONSFILA, sqlresul.* from ("
                                        ...
                                        + "FROM RF_TR_CHEQUESM cheque, RF_TC_CUENTAS_CHEQUES CC "
                                        + "where 1 = 1 "
                                        + lsAnio
      ...
      //                                  + "' and t.programa=substr(c.cuenta_contable,6,4) and t.estatus_cierre_id='2') "
            ...
            <table width='100%'>
                <tr><td width='73%'>&nbsp;</td>
                    ...
                    <td width='80%'>
                        <input type='button' name='btnRegresar' value='Regresar' class='boton' onClick="javascript:LlamaPagina('c749Filtro.jsp?opcion=<%=opcion%>','');" >
                    </td></tr>
            </table>
