...
<html>
  ...
  <body>
    ...
    <%util.tituloPagina(out,"Tesorería","Saldos diarios - Bancos","Arrastre de saldos bancarios",true);%>
      ...
      <table width="50%" align="center" cellpadding="3" class="general">
        ...
        <tbody>
           ...
           <tr>
             <td width="6%"></td>
             <td width="20%">Los últimos saldos registrados en la BD son del día: </td>
             <td width="3%"></td>
             <td width="15%"><%=ultimaFechaBD%></td>
           </tr>
           <tr>
             <td width="6%"></td>
             <td width="20%">Fecha última para arrastre de saldos: </td>
             <td width="3%"></td>
             <td width="15%%">
