...
<html>
  <head>
    ...
    <title>i007tesEfectivoInversionFiltro</title>
    ...
    <script type="text/javascript" language="javascript">
      ...
      function llamamisma(parametro) {
        ...
        fechaInversion = document.getElementById("ffecha");
            ...
            loadSource('dResultado',null,'i005tesEfectivoInversionFiltroCapaResultado.jsp?','idCuentaInversion='+cuentaInversion.value+'&fecha='+fechaInversion.value+'&param='+parametro);
      }
    </script>
  </head>
  <body onload="inicia()">
     <form id='form1' name='form1' action='' method='post'>
      <%util.tituloPagina(out,"Tesorería central","Inversion de efectivo","Filtro",true);%>
