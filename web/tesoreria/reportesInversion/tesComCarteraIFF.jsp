...
<html>
    ...
    <script src="../../Librerias/Javascript/validacionesFecha.js" type="text/javascript">
      ...
      <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesComCarteraIFFCtrl.jsp';
  ...
  %>
  <body>
  <form id="form1" name="form1" action="tesComCarteraIFFCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Composición de la cartera por Institución Financiera y fecha de inversión","Reporte",true);%>
