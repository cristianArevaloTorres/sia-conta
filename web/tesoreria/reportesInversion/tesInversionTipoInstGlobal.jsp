...
<html>
  <head>
    ...
    <title>tesInversionTipoInstGlobal</title>
    ...
    <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesInvTipoInstGlobalCtrl.jsp';
  ...
  <body>
  <form id="form1" name="form1" action="tesInvTipoInstGlobalCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Inversión por tipo de instrumento global","Reporte",true);%>
