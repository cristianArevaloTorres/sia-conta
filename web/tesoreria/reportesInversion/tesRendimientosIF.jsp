...
<html>
    ...
    <script src="../../Librerias/Javascript/validacionesFecha.js" type="text/javascript">
      ...
      <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesRendimientosIFCtrl.jsp';
  ...
  %>
  <body>
  <form id="form1" name="form1" action="tesRendimientosIFCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Rendimientos por Institución Financiera","Reporte",true);%>
