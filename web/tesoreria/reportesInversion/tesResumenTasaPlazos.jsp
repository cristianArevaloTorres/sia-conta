...
<html>
  <head>
    ...
    <title>tesResumenTasaPlazos</title>
  <link rel="stylesheet" href="../../Librerias/Estilos/siaexplorer.css" type="text/css">
    ...
    <script language="JavaScript"  type="text/javascript">
       ...
       function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesResTasaPlazosCtrl.jsp';
  ...
  %>
  <body>
  <form id="form1" name="form1" action="tesResTasaPlazosCtrl.jsp" method="POST">
      <%util.tituloPagina(out,"Tesorería","Resumen de tasas de rendimiento por Plazos","Reporte",true);%>
        ...
        <tbody>
             <tr>
              ...
              <tr>
                <td>Plazos:</td>
                <td>
                  <select class="cajaTexto" id="plazo" name="plazo"> 
