...
<html>
  <head>
    ...
    <title>tesTasasPactadasIDF</title>
    ...
    <script language="JavaScript"  type="text/javascript">
       ...
       return correcto;
        ...
        function asignaValorRep(boton){
         ...
         if (validarFechas()){
             document.getElementById('form1').action='tesTasaPacIDFCtrl.jsp';
  ...
  <body>
  <form id="form1" name="form1" action="tesTasaPacIDFCtrl.jsp" method="POST">
